'use strict';
const en = {
parentGuideKicker:'For parents',parentGuideTitle:'Where should we start?',parentGuideText:'A small guide to choosing activities that match your child’s age and readiness.',parentGuideLink:'Read the parent guide ↗',
